  ...
  namespace module
    {
      ...
      /// from the the nearest sphere surface.  Input points on the sphere surface
      /// are given the value @b +1.0 and the input points equidistant from two
      /// sphere surfaces are given the value @b -1.0.
      ///
