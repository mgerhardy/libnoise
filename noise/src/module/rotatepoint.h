  ...
  namespace module
    {
      ...
      /// Noise module that rotates the input point around the origin and returns
      /// the value from the source module at that point.
      ///
      /// @image html modulerotatepoint.png
      ///
      /// This module's GetValue() method rotates the coordinates of
      /// the input point around the origin before returning the value
      /// from the source module at that point.  To set the rotation
      /// angles, call the SetAngles() method.  To set the rotation
      /// angle around the individual @a x, @a y, or @a z axes, call
      /// the SetXAngle(), SetYAngle() or SetZAngle() methods,
      /// respectively.
      ///
      /// The input point is assumed to be in the left-handed
      /// coordinate system (@a x increases to the right, @a y
      /// increases upward, and @a z increases inward.)
      ///
	...
	public:
	  ...
	  /// Constructor.
	  ///
	  /// The default rotation angle around the @a x axis, in
	  /// degrees, is set to ::DEFAULT_ROTATE_X.
	  ///
	  /// The default rotation angle around the @a y axis, in
	  /// degrees, is set to ::DEFAULT_ROTATE_Y.
	  ///
	  /// The default rotation angle around the @a z axis, in
	  /// degrees, is set to ::DEFAULT_ROTATE_Z.
	  RotatePoint ();
	  ...
	  /// Returns the rotation angle around the @a x axis to apply
	  /// to the input point.
	  ///
	  ...
	  /// Returns the rotation angle around the @a y axis to apply
	  /// to the input point.
	  ///
	  ...
	  /// Returns the rotation angle around the @a z axis to apply
	  /// to the input point.
	  ///
	  ...
	  /// Sets the rotation angles around all three axes to apply
	  /// to the input point.
	  ///
	  ...
	  /// Sets the rotation angle around the @a x axis to apply to
	  /// the input point.
	  ///
	  /// @param xAngle The rotation angle around the @a x axis, in degrees.
	  ///
	  ...
	  /// Sets the rotation angle around the @a y axis to apply to
	  /// the input point.
	  ///
	  /// @param yAngle The rotation angle around the @a y axis, in degrees.
	  ///
	  ...
	  /// Sets the rotation angle around the @a z axis to apply to
	  /// the input point.
	  ///
	  /// @param zAngle The rotation angle around the @a z axis, in degrees.
	  ///
	...
	protected:
	  ...
	  /// An entry within the 3x3 rotation matrix used for
	  /// rotating the input point.
	  double m_x1Matrix;
