...
namespace noise
{
  ...
  namespace module
  {
    ...
    ///
    /// A terracing curve is defined by two or more <i>terracing points</i>.
    /// The slope of the terracing curve is zero to the immediate right of a
    /// terracing point; the slope smoothly increases towards the right until
    /// the next terracing point is reached.  To add a terracing point to
    /// this noise module, call the AddTerracePoint() method.
    ///
    /// This noise module clamps the value from the source module if that
    /// value is less than the value of the lowest terracing point or greater
    /// than the value of the highest terracing point.
    ///
    /// There is no limit to the number of terracing points that can be added
    /// to the curve.  There must be a minimum of two terracing points on the
    /// curve before an application can call the GetValue() method. The
    /// terracing points can have any value, although no two terracing points
    ...
    class Terrace: public Module
    {
        ...
        /// determine the number of terracing points in this array.
	      ///
        ...
        /// produce the terracing curve.
	      ...
	      ///
	      /// If the individual curves are not inverted, the slope of the
        /// terracing curve is zero to the immediate right of a terracing
        /// point; the slope smoothly increases towards the right until the
        /// next terracing point is reached.
	      ///
	      /// If the individual curves are inverted, the slope of the terracing
        /// curve is zero to the immediate left of a terracing point; the
        /// slope smoothly decreases towards the left until the previous
        /// terracing point is reached.
        ...
        bool IsTerracesInverted () const
        {
	      ...
	      ///
	      /// @param terracePointCount The number of terracing points to
        /// generate.
	      ///
	      /// @pre The number of terrace points must be greater than or equal to
	      /// @b 2.
	      ///
	      /// @post The previous terracing points stored in this noise module
        /// are deleted.
	      ///
	      /// @throw NoiseEx
    	...
    	protected:
	      ...
	      ///   preconditions for more information.
	      ///
	      /// By inserting the terracing point at the returned array index, this
        /// class ensures that the terracing point array is sorted by value.
        /// The code that maps a value onto the curve requires a sorted
        /// terracing point array.
        ...
        /// insert the terracing point.
	      /// @param value The value of the terracing point.
	      ///
	      /// To make room for this new terracing point, this method reallocates
        /// the terracing point array and shifts all terracing points
        /// occurring after the insertion position up by one.
	      ///
	      /// Because the curve mapping algorithm in this module requires that
        /// all terracing points in the array be sorted by value, the new
        /// terracing point should be inserted at the position in which the
