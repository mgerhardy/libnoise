  ...
  namespace module 
    {
      ...
      ///
      /// <i>Turbulence</i> is the pseudo-random displacement of the
      /// input point.  This noise module's GetValue() method randomly
      /// displaces the ( @a x, @a y, @a z ) coordinates of the input
      /// point before retrieving the value from the source module at
      /// that point.  To control the turbulence, an application can
      /// modify its <i>frequency</i> and its <i>power</i>.
      ///
      /// The <i>frequency</i> determines how rapidly the coordinates
      /// of the input point changes by displacement.  To specify the
      /// frequency, call the SetFrequency() method.
      ///
      /// The <i>power</i> determines the scale of the displacement of
      /// the input point.  The power is a scaling value applied to
      /// each of the @a x, @a y, and @a z coordinates of the input
      /// point.  To specify the power, call the SetPower() method.
      ///
      /// Use of this noise module may require some trial and error.
      /// Assuming you are using a Perlin or Voronoi noise
      /// module as the source module, you should first: - Set the
      /// frequency to the same frequency as the source module.  - Set
      /// the power to the reciprocal of the frequency.
      ///
      /// From these initial frequency and power values, modify these values until
      /// this noise module produce the desired changes in your terrain or
      /// texture.  For example:
      ...
      /// module displaces the @a x coordinate, one displaces the @a y coordinate,
      /// and one displaces the @a z coordinate.
      ///
	...
	public:
	  ...
	  /// @param seed The seed.
	  ///
	  /// Internally, there are three Perlin modules that displace the
	  /// input point; one for the @a x, one for the @a y, and one for the
	  /// @a z coordinate.  This noise module assigns the following
	  /// seeds to the Perlin module:
