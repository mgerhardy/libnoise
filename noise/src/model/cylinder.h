...
namespace noise
{
  ...
  namespace model
  {
    ...
    ///
    /// To return a noise value from a point on the cylinder, pass an angle
    /// and a height to the GetValue() method.
    ///
    /// The cylinder has a radius of @b 1.0 unit and has infinite height.  The
    /// cylinder is oriented along the @a y axis.  The center of the cylinder
    /// is located at ( @b 0.0, @b 0.0, @b 0.0 ).
    class Cylinder
    {
