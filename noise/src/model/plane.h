...
namespace noise
{
  ...
  /// of a plane passing through the origin along the X and Z axes.
  ///
  /// To return a noise value from a point on the sphere, pass the X
  /// and Z coordinates to the GetValue() method.
  ///
    class Plane {
    public:
