...
namespace noise
{
  ...
  namespace model
  {
    ...
    ///
    /// To return a noise value from a point on the sphere, pass a latitude and
    /// longitude to the GetValue() method.
    ///
	...
	/// method.
	///
	/// Use negative latitude values for points on the southern hemisphere.
	///
	/// Use negative longitude values for points on the western hemisphere.
